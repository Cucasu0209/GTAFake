...
public class EnemySpawner : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        while (true)
        {
            ...
            GameObject enemy = LeanPool.Spawn(EnemyPrefabs[Random.Range(0, EnemyPrefabs.Length)], Map.GetRandomPositionInCircle(Player.transform, RadiousExpanding), Quaternion.identity);
    ...
    private void Update()
    {
        Map.UpdateFollowing(Player.transform, RadiousExpanding);
    }
